...
public class Main {
    public static void main(String[] args) {
        ...
        // Creo voli di test
        voloService.creaVolo("AZ123", "MXP", "FCO", LocalTime.of(14, 30), 850, LocalDate.of(2025, 7, 16));   
        voloService.creaVolo("AZ124", "MXP", "FCO", LocalTime.of(14, 45), 850, LocalDate.of(2025, 7, 16));
        voloService.creaVolo("AZ125", "MXP", "FCO", LocalTime.of(14, 50), 850, LocalDate.of(2025, 7, 16));
        voloService.creaVolo("AZ126", "FCO", "MXP", LocalTime.of(18, 30), 900, LocalDate.of(2025, 7, 15));
        voloService.creaVolo("AZ127", "MXP", "FCO", LocalTime.of(20, 00), 800, LocalDate.of(2025, 7, 14));
        voloService.creaVolo("AZ128", "LIN", "NAP", LocalTime.of(10, 00), 850, LocalDate.of(2025, 7, 15));
